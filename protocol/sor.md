...
Yogi Studio has developed the [SOR package](https://github.com/yogi-fi/yogi-sor), an easy to use implementation of the above concepts. For documentation for working with the package please see this [page](https://docs.yogi.fi/sor/development).
