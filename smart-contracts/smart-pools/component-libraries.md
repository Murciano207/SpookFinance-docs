...
* **SafeApprove** - an internal library \(adapted from PieDAO\) to enable pools to contain BEP20 tokens that require approve calls to be made from a base of 0 \(e.g., KNC\)
