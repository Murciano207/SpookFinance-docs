...
[This page](https://github.com/yogi-fi/yogi-docs/tree/cc5cc586ce3506cdd8ecb27b34cc15dd24cebe44/core-concepts/yogi-liquidity-mining/exchange-and-reward-listing.md) describes the process.
...
One final note - if you deploy a CRP through a script, we recommend using the standard `CRPFactory` \(addresses [here](../addresses.md)\). If you deploy it "directly", it will still work, but will not be recognized by the YOGI mining scripts, and you will need to do a [redirect](https://github.com/yogi-fi/yogi-docs/tree/cc5cc586ce3506cdd8ecb27b34cc15dd24cebe44/core-concepts/bal-liquidity-mining/README.md).
