...
* **Factory**: The official BPool factory. Pools deployed from this factory appear on Yogi user interfaces \(e.g., the [Exchange](https://exchange.yogi.fi/#/swap) and [Pool Manager](https://pools.balancer.exchange/#/)\).
